...
create_vpc = true
region = "us-east-1"
vpc_name = "observability_eks_vpc"
...
ecr_name = "observability_eks_ecr"
eks_cluster_name = "observability_eks_cluster"
eks_cluster_version  = "1.23"
cluster_min_node_count = 1
cluster_max_node_count = 3
cluster_node_instance_type = ["t3a.medium","t3a.xlarge"]
cluster_node_billing_mode = "ON_DEMAND"
cluster_node_disk_size = "200"
bucket_cluster_logs_name = "observability_eks_logs"
cluster_logs_path = "cluster_logs"
node_logs_path = "node_logs"
monthly_billing_threshold = 200
billing_currency = "USD"
create_bastion = 1
rds_cluster_name = "observability-eks-rds"
db_name = "observabilityeksdb"
db_master_user = "observabilityeksmasteruser"
eks_master_role = "arn:aws:iam::219596081057:role/aws-reserved/sso.amazonaws.com/AWSReservedSSO_AWSAdministratorAccess_c87e108deaf1b7ca"
map_roles = [
  #{
...
map_users = [
  {
    userarn  = "arn:aws:iam::219596081057:user/deployment-user"
    username = "kubernetes-service-account"
    groups   = ["system:masters"]
  },
  {
    userarn  = "arn:aws:iam::219596081057:user/andres"
    username = "observability_eks_cluster-dev-K8sFullAdmin"
    groups   = ["system:masters"]
  }
]
